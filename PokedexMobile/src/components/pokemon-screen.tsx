...
> = {
  fuego: { backgroundColor: "#4A1D12", textColor: "#FF9B6A", borderColor: "#78341F" },
  agua: { backgroundColor: "#132E50", textColor: "#7EB8FF", borderColor: "#285487" },
  planta: { backgroundColor: "#123523", textColor: "#6FE0A0", borderColor: "#275C42" },
  eléctrico: { backgroundColor: "#3A3110", textColor: "#F8D95A", borderColor: "#6D5B20" },
  electrico: { backgroundColor: "#3A3110", textColor: "#F8D95A", borderColor: "#6D5B20" },
  hielo: { backgroundColor: "#14343B", textColor: "#8CE5F3", borderColor: "#28616B" },
  lucha: { backgroundColor: "#461F22", textColor: "#FF9B95", borderColor: "#77373B" },
  veneno: { backgroundColor: "#3B1643", textColor: "#E48AF2", borderColor: "#682874" },
  tierra: { backgroundColor: "#3D2B1E", textColor: "#DDA86E", borderColor: "#6A4A31" },
  volador: { backgroundColor: "#242846", textColor: "#B0B6F2", borderColor: "#454D7B" },
  psíquico: { backgroundColor: "#431C33", textColor: "#FF8DBB", borderColor: "#723454" },
  psiquico: { backgroundColor: "#431C33", textColor: "#FF8DBB", borderColor: "#723454" },
  bicho: { backgroundColor: "#2A3416", textColor: "#BFD971", borderColor: "#4D612B" },
  roca: { backgroundColor: "#393322", textColor: "#D8C983", borderColor: "#605536" },
  fantasma: { backgroundColor: "#2D1F4E", textColor: "#C8A5FF", borderColor: "#513A7D" },
  dragón: { backgroundColor: "#20254E", textColor: "#9AA8FF", borderColor: "#3F4A83" },
  dragon: { backgroundColor: "#20254E", textColor: "#9AA8FF", borderColor: "#3F4A83" },
  siniestro: { backgroundColor: "#252A33", textColor: "#C4CCD8", borderColor: "#454D5B" },
  acero: { backgroundColor: "#21303C", textColor: "#A9C4D8", borderColor: "#3B566B" },
  hada: { backgroundColor: "#421D35", textColor: "#F4A1CB", borderColor: "#70405A" },
  normal: { backgroundColor: "#29313A", textColor: "#C9D2DC", borderColor: "#4A5764" },
};
